...
import Model3d from "../../../models-3d/panneau-contacte.glb";
...
function Contacte(){
    ...
    useEffect(() => {
        ...
        canvas.style.marginLeft = window.innerWidth <= 1117 ? '2vw' : '3vw'; // Modifier la marge gauche en fonction de la largeur de la fenêtre
